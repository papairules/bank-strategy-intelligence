...
export function StrategicSignalsPage() {
  ...
  return <div className="page">
    ...
    {result.data && <>
      ...
      <div id="ask-strategy"><AskStrategyPanel organization={CURRENT_ORGANIZATION} /></div>
    </>}
  </div>;
}
