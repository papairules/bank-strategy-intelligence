...
class TechnologyAgentTools:
    ...
    def get_summary(self, request: OrganizationInput) -> AgentTechnologySummary:
        ...
        return AgentTechnologySummary(
            ...
            source_technology_jobs=snapshot.source_technology_jobs,
            source_technology_observation_count=snapshot.source_technology_observation_count,
            source_technology_coverage=snapshot.source_technology_coverage_percentage / 100,
